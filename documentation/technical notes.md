...
* `$44$: Variable 044` Enemy Type 1 - Defeated OffsetX - `number`. (used in the enemy take damage script to position the defeated enemy animation over enemy actor type 1)
* `$45$: Variable 045` Enemy Type 1 - Defeated OffsetY - `number`. (used in the enemy take damage script to position the defeated enemy animation over enemy actor type 1)
* `$46$: Variable 046` Enemy Type 1 - Collectable OffsetX - `number`. (used in the enemy take damage script to position the collectable over enemy actor type 1)
* `$47$: Variable 047` Enemy Type 1 - Collectable OffsetY - `number`. (used in the enemy take damage script to position the collectable over enemy actor type 1)
* `$48$: Variable 048` Enemy Type 2 - Defeated OffsetX - `number`. (used in the enemy take damage script to position the defeated enemy animation over enemy actor type 2)
* `$49$: Variable 049` Enemy Type 2 - Defeated OffsetY - `number`. (used in the enemy take damage script to position the defeated enemy animation over enemy actor type 2)
* `$50$: Variable 050` Enemy Type 2 - Collectable OffsetX - `number`. (used in the enemy take damage script to position the collectable over enemy actor type 2)
* `$51$: Variable 051` Enemy Type 2 - Collectable OffsetY - `number`. (used in the enemy take damage script to position the collectable over enemy actor type 2)
